...
-- Customers (must be before SalesOrders due to FK)
...
-- Test users (passwords: manager123, staff123)
INSERT INTO Users (RoleId, Username, PasswordHash, FullName, PhoneNumber, Email, IsActive, CreatedAt, UpdatedAt)
SELECT
    (SELECT Id FROM Roles WHERE Code = 'MANAGER'),
    'manager01',
    '$2b$10$8YWUg7w2cVCneu/gAb1VAeLiSc9oZCD554zyGUZ.oo16INXlzIT3a',
    'Manager Test',
    NULL,
    NULL,
    TRUE,
...
SELECT
    ...
    'staff01',
    '$2b$10$tCI/yf0zWIJkE.YCaxB/t.ODFTrCo7yTzWYtzE3xROxq5hPDvmyzS',
    'Staff Test',
    NULL,
    NULL,
    TRUE,
