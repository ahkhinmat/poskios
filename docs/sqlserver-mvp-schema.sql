...
CREATE TABLE dbo.PosDraftTabs (
    ...
    PurchaseOrderCode NVARCHAR(50) NULL,
    SupplierId INT NULL,
    SupplierOrderCode NVARCHAR(50) NULL,
    SupplierInvoiceCode NVARCHAR(50) NULL,
    PurchaseStatus NVARCHAR(30) NULL,
    SupplierPaidAmount DECIMAL(18,2) NULL CONSTRAINT DF_PosDraftTabs_SupplierPaidAmount DEFAULT (0),
